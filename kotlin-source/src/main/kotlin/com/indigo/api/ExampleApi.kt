...
import com.indigo.flow.ExampleFlow.Initiator
...
// This API is accessible from /api/indigo. All paths specified below are relative to it.
@Path("example")
class ExampleApi(val rpcOps: CordaRPCOps) {
     ...
     * see it when calling /api/indigo/ious on their respective nodes.
     *
